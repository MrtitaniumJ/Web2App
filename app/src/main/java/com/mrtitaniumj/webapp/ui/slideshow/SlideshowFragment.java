package com.mrtitaniumj.webapp.ui.slideshow;
...
import com.mrtitaniumj.webapp.databinding.FragmentSlideshowBinding;
...
public class SlideshowFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        aboutWebView.setOnKeyListener(new View.OnKeyListener() {
            @Override
